...
mb = {'name': 'Moses Brown School', 'parameters': {'lat': 41.8334, 'lon': -71.3985, 'alt': 43, 'n': 5}}

iss_response = requests.get('http://api.open-notify.org/iss-pass.json', params=mb['parameters'])
